...
| `PRETRAIN_HF_REPO` | `$(HF_NAMESPACE)/slm-synthetic-pretrain` unless `HF_REPO` is set | Destination Hugging Face dataset repo for pretraining. Smoke/production run names do not change the repository name. |
