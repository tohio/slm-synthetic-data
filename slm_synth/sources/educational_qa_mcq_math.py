...
from slm_synth.schemas import EDUCATIONAL_QA_MCQ_MATH_SCHEMA
from prompts.educational_qa_mcq_math import EDUCATIONAL_QA_MCQ_MATH_TASK
...
class EducationalQAMCQMathGenerator:
    ...
    def generate_batch(self):
        ...
        return [repair_educational_qa_mcq_math(obj) for obj in objs]
