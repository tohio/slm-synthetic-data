...
PRETRAIN_TARGET_TOKENS ?= 2000000
...
DISTILLATION_SFT_SMOKE_SIGNALS ?= all
...
DISTILLATION_SFT_SEEDS ?= 3
DISTILLATION_SFT_DERIVATIONS_PER_SEED ?= 10
DISTILLATION_SFT_TASKS_PER_DERIVATION ?= 15
DISTILLATION_SFT_SMOKE_SEEDS ?= 3
DISTILLATION_SFT_SMOKE_DERIVATIONS_PER_SEED ?= 2
...
DISTILLATION_DPO_SMOKE_DIMENSIONS ?= all
DISTILLATION_DPO_SMOKE_DIMENSIONS_EFFECTIVE := $(if $(filter file,$(origin DISTILLATION_DPO_DIMENSIONS)),$(DISTILLATION_DPO_SMOKE_DIMENSIONS),$(DISTILLATION_DPO_DIMENSIONS))
DISTILLATION_DPO_SEEDS ?= 5
DISTILLATION_DPO_DERIVATIONS_PER_SEED ?= 6
DISTILLATION_DPO_TASKS_PER_DERIVATION ?= 15
DISTILLATION_DPO_SMOKE_SEEDS ?= 5
DISTILLATION_DPO_SMOKE_DERIVATIONS_PER_SEED ?= 2
...
SFT_FAMILIES ?= all
SFT_SMOKE_FAMILIES ?= all
SFT_RUN_ROOT ?= data/sft/runs
SFT_SEEDS ?= 5
SFT_DERIVATIONS_PER_SEED ?= 6
SFT_TASKS_PER_DERIVATION ?= 15
SFT_SMOKE_SEEDS ?= 5
SFT_SMOKE_DERIVATIONS_PER_SEED ?= 2
...
>   --seeds $(DISTILLATION_SFT_SMOKE_SEEDS) \
...
>   --seeds $(DISTILLATION_DPO_SMOKE_SEEDS) \
